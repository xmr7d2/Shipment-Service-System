...
public class SaleControllerTest {
    ...
    public void findIdTest () throws Exception {
        // 添加调用的接口路径
        MockHttpServletRequestBuilder postRequestBuilder = MockMvcRequestBuilders.post("/api/sale/search/橙子");
        // 标识数据提交方式
...
//        resultActions.andExpect(MockMvcResultMatchers.status().isOk());
    ...
    public void findAllTest() throws Exception {
        // 添加调用的接口路径
        MockHttpServletRequestBuilder postRequestBuilder = MockMvcRequestBuilders.post("/api/sale");
        // 标识数据提交方式
        postRequestBuilder.contentType(MediaType.APPLICATION_JSON);
        // 参数
