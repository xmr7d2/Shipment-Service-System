...
//        // 添加调用的接口路径
//        MockHttpServletRequestBuilder postRequestBuilder = MockMvcRequestBuilders.post("/api/vehicle/1");
//        // 标识数据提交方式
...
//        // 添加调用的接口路径
//        MockHttpServletRequestBuilder postRequestBuilder = MockMvcRequestBuilders.post("/api/vehicle");
//        // 标识数据提交方式
//        postRequestBuilder.contentType(MediaType.APPLICATION_JSON);
//
//        ResultActions resultActions = mockMvc.perform(postRequestBuilder);
